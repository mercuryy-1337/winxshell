...
enum ICON_ID {
    ...
    ICID_TRAY_DARK_SND_NONE,
    ICID_TRAY_DARK_SND_LARGE = ICID_TRAY_SND_LARGE + ICID_TRAY_DARK_SND_NONE - ICID_TRAY_SND_NONE,

    ICID_TRAY_NET_WIRED_DIS,
    ICID_TRAY_NET_WIRED_LAN,
    ICID_TRAY_NET_WIRED_INTERNET,
    ICID_TRAY_NET_WIRELESS_DIS,
    ICID_TRAY_NET_WIRELESS_NOCONN_LEGACY,
    ...
    ICID_TRAY_DARK_NET_WIRED_DIS,
    ICID_TRAY_DARK_NET_SIGNAL_QUARTER4 = ICID_TRAY_NET_SIGNAL_QUARTER4 + ICID_TRAY_DARK_NET_WIRED_DIS - ICID_TRAY_NET_WIRED_DIS,
...
extern BOOL draw_icon_high_quality(HDC hdc, HICON hIcon, const RECT &rect, BYTE alpha = 255);
