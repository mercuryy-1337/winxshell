...
This repository is the rebranded Explauncher line and the current public app version is 1.0.3.
...
## Notable 1.0.3 changes

- Rebased visible product versioning to `1.0.3` for the Explauncher line.
